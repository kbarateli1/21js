...
// #1 დავალების შესრულების შემდეგ სერვერი დააბრუნებს მესიჯს { type: 'userTyping', data: 'იმის სახელი ვინც დაიწყო მესიჯში აკრეფა' }.
// ეს დაბრუნებული მესიჯი უნდა ჩავსვათ  html-ში span  'typing-indicator'
//  შეინახეთ ცვლადში და ამ ლემენტში უნდა ჩაწეროთ შემდეგი სტრინგი "სახელი (სახელი დაბრუნდება data ში) is Typing...",  
//  და ეს ტექსტი უნდა გაქრეს 1 წამის შემდეგ. (ვინც წერს იმასთან არ დაბრუნდება ეს სერვერიდან შეამოწმეთ სხვა ტაბში)
